...
// include: C:\Users\josue\AppData\Local\Temp\tmp7fhyxbw2.js
  ...
  (() => {
    ...
    async function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'juego_final_ok.data';
      var REMOTE_PACKAGE_BASE = 'juego_final_ok.data';
...
Module['FS_createPath']("/", "resources", true, true);
    ...
    for (var file of metadata['files']) {
      ...
      async function processPackageData(arrayBuffer) {
        ...
        Module['removeRunDependency'](`fp ${name}`);
          ...
          Module['removeRunDependency']('datafile_juego_final_ok.data');
      }
      Module['addRunDependency']('datafile_juego_final_ok.data');
    ...
    loadPackage({"files": [{"filename": "/resources/asteroid0.png", "start": 0, "end": 1393339}, {"filename": "/resources/explosion.wav", "start": 1393339, "end": 2327305}, {"filename": "/resources/explosion7.png", "start": 2327305, "end": 2854054}, {"filename": "/resources/music1.mp3", "start": 2854054, "end": 8802136}, {"filename": "/resources/ship0.png", "start": 8802136, "end": 10196518}, {"filename": "/resources/shot.wav", "start": 10196518, "end": 10498608}, {"filename": "/resources/space_bg3.png", "start": 10498608, "end": 11876414}], "remote_package_size": 11876414});

  })();

// end include: C:\Users\josue\AppData\Local\Temp\tmp7fhyxbw2.js
// include: C:\Users\josue\AppData\Local\Temp\tmp840dq24t.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: C:\Users\josue\AppData\Local\Temp\tmp840dq24t.js
// include: C:\Users\josue\AppData\Local\Temp\tmpbj8rp3x2.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: C:\Users\josue\AppData\Local\Temp\tmpbj8rp3x2.js
...
function findWasmBinary() {
  return locateFile('juego_final_ok.wasm');
}
...
var ASM_CONSTS = {
 ...
 145972: ($0) => { miniaudio.untrack_device_by_index($0); },  
 146015: ($0) => { var device = miniaudio.get_device_by_index($0); device.webaudio.resume(); device.state = miniaudio.device_state.started; },  
 146140: ($0) => { var device = miniaudio.get_device_by_index($0); device.webaudio.suspend(); device.state = miniaudio.device_state.stopped; }
};
